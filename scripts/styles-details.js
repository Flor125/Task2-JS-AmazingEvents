...
function paintDOM(usersArray){
  ...
  console.log("tagToUpdate", tagToUpdate);
      ...
      <div class="col-md-7 order-md-2 my-5">
          <h2 class="featurette-heading fw-normal ">${usersArray[0].events[0].name}</h2>
          <p class="lead">${usersArray[0].events[0].description}</p>
          <p class="lead">Capacity: ${usersArray[0].events[0].assistance}</p>  
          <p class="lead">Place: ${usersArray[0].events[0].place} </p>
        </div>
        <div class="col-md-5 order-md-1">
          <img src="${usersArray[0].events[0].image}" class="card-img-top" alt="${usersArray[0].events[0].date}" width="300" height="300">  
        </div>
      `;
